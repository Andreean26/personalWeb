...
<head>
    <meta charset="utf-8">
    <title>Adam Andreean Personal- Website</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <div class="navbar navbar-expand-lg bg-light navbar-light">
        <div class="container-fluid">
            <a href="#home" class="navbar-brand">Adam Andreean</a>
            ...
            <div class="row align-items-center">
                <div class="col-sm-12 col-md-6">
                    <div class="hero-content">
                        <div class="hero-text">
                            <p>Hello I'm</p>
                            <h1>Adam Fawazzaky Fardy Andreean</h1>
                            <h2></h2>
                ...
                <div class="col-sm-12 col-md-6 d-none d-md-block">
                    <div class="hero-image">
                        <img src="https://cdn.discordapp.com/attachments/330320161263583232/1085085722240888892/Subject.png"
                            alt="Hero Image">
                    </div>
                </div>
            </div>
    ...
    <!-- Testimonial Start -->
    <div class="testimonial wow fadeInUp" data-wow-delay="0.1s" id="quotes">
        <div class="container">
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="footer-info">
                    <h2>Adam Andreean</h2>
                    <h3>18A Tenggilis Kauman, Surabaya, Indonesia</h3>
                    <div class="footer-menu">
                        <p>+6282132082482</p>
                        <p>adam.andreean@binus.ac.id</p>
                        <p>fawazzakyadam26@gmail.com</p>
                    </div>
                    <div class="footer-social">
                        <a href=""><i class="fab fa-twitter"></i></a>
                        <a href=""><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/andreeanadam/"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/in/adam-fawazzaky-2739b3222/"><i
                                class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            </div>
            <div class="container copyright">
                <p>&copy; <a href="#">Adam Andreean</a>, All Right Reserved | Designed By <a
                        href="https://htmlcodex.com">Who?</a></p>
            </div>
        </div>
    </div>
    <!-- Footer End -->
